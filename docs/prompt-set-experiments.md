...
The repository now has shared schema types, tests, and checked-in sample fixtures for the prompt-set contract. Runtime collection and provider integrations remain future work.
